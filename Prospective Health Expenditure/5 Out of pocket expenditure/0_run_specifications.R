...
# Input filepath to retrospective pipeline OOP/GDP outputs
...
ensemble_metadata <- list(
  yvar = c(yvv),
  xvar = paste0("FE_", c("ln_gdppc", "logit_pop64", "logit_gge_gdp", "logit_dah_gdp", "logit_ghe_gdp", "logit_ppp_gdp")),
  re_coef = NULL,
  ar = c(2, 3),
  ar_mod = c(1),
  ma = c(0),
