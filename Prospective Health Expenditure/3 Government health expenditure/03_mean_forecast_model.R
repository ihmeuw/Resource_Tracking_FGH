############################################
### Author: USERNAME
### Purpose: Run submodel mean estimates using TBM, holding out OOS years and assessing submodel goodness of git 
############################################
rm(list = ls())
...
## Bring in full data
input_data <- fread(metadata_list$prepped_inputs_path)[year <= metadata_list$end_FC]
...
## Get the statistics from the resids (MAD, median, mean, SD, etc)
